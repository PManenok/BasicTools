package by.esas.tools.dialog_message
...
import by.esas.tools.dialog_message.MessageDialog.ButtonAppearance
import by.esas.tools.dialog_message.databinding.DfMessageBinding
import by.esas.tools.dialog_message.databinding.IDialogMessageBinding
...
open class MessageDialog : BindingDialogFragment<DfMessageBinding> {
    ...
    override fun onViewStateRestored(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            itemTextAlignment =
                savedInstanceState.getInt("textAlignment", View.TEXT_ALIGNMENT_TEXT_START)
    ...
    protected open fun saveButtonState(
        tag: String,
    ...
    protected open fun updateButtonAppearance(
            ...
            btnView.apply {
                ...
                setBackgroundColor(
                    ContextCompat.getColor(
                        requireContext(),
                        appearance.backgroundColorResId
                    )
                )
            }
        }
