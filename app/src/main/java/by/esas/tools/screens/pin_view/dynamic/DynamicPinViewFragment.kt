...
class DynamicPinViewFragment: AppFragment<DynamicPinViewVM, FMainDynamicPinViewBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fDynamicPinButtonCreate.setOnClickListener {
            ...
            pin.setDefaults()
            pin.setPinAmount(binding.fDynamicPinAmount.text.toString().convertToInt())
            ...
            pin.setAnimInDuration(binding.fDynamicPinTimeIn.text.toString().convertToInt())
            pin.setAnimOutDuration(binding.fDynamicPinTimeOut.text.toString().convertToInt())
            pin.setPinSize(dpToPx(binding.fDynamicPinSize.text.toString().convertToInt()))
            pin.setPinMargins(dpToPx(binding.fDynamicPinMargins.text.toString().convertToInt()))
